...
const helpCommands = [
  ...
  // --- KATEGORIA 2: SOCJALNE I GANGI ---
  {
    ...
    description: "🏆 Pokazuje top 5 najbogatszych graczy, top 3 gangów lub top 5 największych femboyów. Dostępne podkomendy: !top lvl (ranking poziomów), !top daily (ranking daily streak), !top rob (ranking napadów).",
    usage: "!top [gang/femboy/lvl/daily]",
    examples: ["!top","!top gang","!top femboy","!top lvl","!top daily","!top rob"],
    cooldown: "8 sekund",
    requirements: "Brak.",
    aliases: ["ranking"],
  ...
  },
  {
    ...
    description: "📅 Pokazuje top 5 graczy z najdłuższym daily streak (ciągiem odbieranych nagród dziennych). Dostępne też jako !top daily.",
    usage: "!topdaily | !top daily",
    examples: ["!topdaily","!top daily"],
    cooldown: "8 sekund",
    requirements: "Brak.",
  ...
  },
  {
    ...
    description: "🏅 Wyświetla ranking 5 graczy z najwyższym poziomem (lvl) oraz ich prestiżem. Ranking uwzględnia prestiż (każdy prestiż dodaje 100 poziomów). Dostępne też jako !top lvl.",
    usage: "!toplvl | !top lvl",
    examples: ["!toplvl","!top lvl"],
    cooldown: "8 sekund",
    requirements: "Brak.",
  ...
  },
  {
    ...
    description: "🔪 Wyświetla ranking 5 graczy z największą liczbą napadów (!rob). Dostępne też jako !top rob.",
    usage: "!toprob | !top rob",
    examples: ["!toprob","!top rob"],
    cooldown: "8 sekund",
    requirements: "Brak.",
    aliases: ["rankingrob"],
