...
const helpCommands = [
  ...
  // --- KATEGORIA 2: SOCJALNE I GANGI ---
  {
    ...
    description: "🏆 Pokazuje top 5 najbogatszych graczy, top 3 gangów lub top 5 największych femboyów. Dostępne podkomendy: !top lvl (ranking poziomów), !top daily (ranking daily streak).",
    usage: "!top [gang/femboy/lvl/daily]",
    examples: ["!top","!top gang","!top femboy","!top lvl","!top daily"],
    cooldown: "8 sekund",
    requirements: "Brak.",
    aliases: ["ranking"],
