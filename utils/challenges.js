...
const CHALLENGES = [
  ...
  { id: 'cf_streak_4', type: 'coinflip_streak', label: 'Farciarz', description: 'Wygrywaj !coinflip 4 razy pod rzad (min. 10k stawka)', target: 4, minBet: 10000, reward: 80000 },
  { id: 'crime_10', type: 'crime_count', label: 'Przestepca', description: 'Uzyj !crime 10 razy', target: 10, reward: 250000 },
  { id: 'pkn_streak_3', type: 'pkn_streak', label: 'Manipulant', description: 'Wygrywaj !pkn 3 razy pod rzad (min. 20k stawka)', target: 3, minBet: 20000, reward: 250000 },
  { id: 'slots_streak_5', type: 'slots_streak', label: 'Dzordzo 5', description: 'Wygrywaj !slots 5 razy pod rzad (min. 10k stawka)', target: 5, minBet: 10000, reward: 150000 },
  { id: 'ruletka_streak_5', type: 'ruletka_streak', label: 'Urodzony hazardzista', description: 'Wygrywaj !ruletka 5 razy pod rzad (min. 10k stawka)', target: 5, minBet: 10000, reward: 120000 },
  ...
  { id: 'cr_3', type: 'chickenroad_wins', label: 'Kurczak na trasie', description: 'Ukoncz 3 gry w !chickenroad (min. poziom Hard, min. 25k stawka)', target: 3, minBet: 25000, difficulty: 'hard', reward: 425000 }
];
